    ...
    stages {
        ...
        stage('Build') {
            steps {
                ...
                bat "C:\\xampp\\php\\php.exe C:\\ProgramData\\ComposerSetup\\bin\\composer remove phpunit/phpunit"
                bat "C:\\xampp\\php\\php.exe C:\\ProgramData\\ComposerSetup\\bin\\composer require --dev phpunit/phpunit ^9"
